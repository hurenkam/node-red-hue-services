module.exports = function(RED) {
    ...
    class RoomNode extends Resource {
        ...
        onInitialUpdate(event) {
            ...
            console.log("RoomNode[" + this.config.name + "].onInitialUpdate()");
            console.log(event)
    
            this.services = this.clip.getSortedDeviceServices(this.config.uuid,"room");
            console.log(this.services)
    
            this.services.forEach((service) => {
                this.clip.on(service.rid, (event) => {
                    console.log("RoomNode["+this.config.name+"].clip.on(" + service.rid + ")");
                    console.log(event);
        ...
        onInput(msg) {
            console.log("RoomNode["+this.name+"].onInput()");
            console.log(msg);
        ...
        onClose() {
            //console.log("RoomNode["+this.name+"].onClose()");
            this.services = null;
            super.onClose();
        }
    }
